...
export const colorDirectionMarker = 0x53BEA4;
export const colorPreviousMarker = 0xF2543D;
export const colorCenterMarker = 0xC1D4BA;

export const colorWall = 0x2B2F3C;
export const colorWallBorder = 0xF0E2BD;